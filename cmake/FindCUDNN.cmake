...
find_library(CUDNN_LIBRARY
  NAMES libcudnn.so.${CUDNN_FIND_VERSION} libcudnn${__cudnn_ver_suffix}.dylib ${__cudnn_lib_win_name}
  PATHS $ENV{LD_LIBRARY_PATH} ${__libpath_cudart} $ENV{CUDNN_ROOT_DIR} ${PC_CUDNN_LIBRARY_DIRS} ${CMAKE_INSTALL_PREFIX}
...
if(CUDNN_LIBRARY)
  ...
  find_path(CUDNN_INCLUDE_DIR
    NAMES cudnn.h
    HINTS ${PC_CUDNN_INCLUDE_DIRS} $ENV{CUDNN_ROOT_DIR} ${CUDA_TOOLKIT_INCLUDE} ${__found_cudnn_root}
